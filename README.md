<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=250&section=header&text=Skip%20Safe&fontSize=50&fontColor=00D4FF&fontAlignY=36&desc=BIT%20Mesra%20Attendance%20Risk%20Calculator&descSize=16&descAlignY=53&descColor=ffffff" width="100%" />
</p>

<p align="center">
  <img src="https://img.shields.io/badge/VERSION-1.0.9-00599C?style=for-the-badge&logo=github&logoColor=white" alt="Version" />
...
| **Smart Haptics** | A quick, tactile feedback engine for day navigation, subject cards, and status changes - giving a native feel. |
...
5. **Skips left** = Remaining - Must attend - classes already marked skipped in advance
...
- **PWA:** `manifest.json` (v1.0.9) + Service Worker (`sw.js`) with network-first caching and offline fallback.
